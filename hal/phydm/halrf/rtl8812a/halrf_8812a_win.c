...
)
{
	...
	/* \ADp\BA\E2tmp_lb_gain \A5Ψ쪺function hex2dec() \ACO\B1N twos complement\AA\BA\A4Q\A4\BB\B6i\A6\EC\C2ন\A4Q\B6i\A6\EC, \A4Q\A4\BB\B6i\A6쪺\AE榡\AC\B0s11.10
	* \C1|\A8\D21, d00[10:0] = h'3ff, \B8g\B9L hex2dec(h'3ff) = 1023,
	* \C1|\A8\D22, d00[10:0] = h'400, \B8g\B9L hex2dec(h'400) = -1024,
	* \C1|\A8\D23, d00[10:0] = h'0A9, \B8g\B9L hex2dec(h'0A9) = 169,
	* \C1|\A8\D24, d00[10:0] = h'54c, \B8g\B9L hex2dec(h'54c) = -692,
	* \C1|\A8\D25, d00[10:0] = h'7ff, \B8g\B9L hex2dec(h'7ff) = -1, */
...
)
{
	...
	do {
		...
		/* \AA`\B7Npage c1\AA\BAc90\A6bDPK\B9L\B5{\A4\A4\A4d\B8U\A4\A3\AF\E0\B3Q\A8\E4\A5Lthread or process\A7\EF\BCg\A6\A8page c\AA\BAc90\AD\C8 */
		odm_write_4byte(dm, 0xc90, 0x0101f018);

		/* one shot */
		odm_write_4byte(dm, 0xcc8, 0x800c5599);
		odm_write_4byte(dm, 0xcc8, 0x000c5599);
		/* delay 50 ms,\C5\FD delay \AEɶ\A1\AA\F8\A4@\C2I, \BDT\A9w PA Scan function \A6\B3\B0\B5\A7\B9 */
		delay_ms(50);

		/* reg82c[31] = 0 --> \A4\C1\A8\EC page C */
...
)
{
	...
	/* reg82c[31] = b'0, \A4\C1\B4\AB\A8\EC page C */
	odm_write_4byte(dm, 0x82c, 0x002083dd);
	...
	/* reg82c[31] = 1 --> \A4\C1\A8\EC page C1 */
	odm_write_4byte(dm, 0x82c, 0x802083dd);
...
)
{
	...
	odm_set_bb_reg(dm, R_0xcd4, 0xFFF000, 0x100);  /* \B1Ncd4[23:12] \A7令 h'100, \A8䥦\A6줸\BDЫO\AFd\AD\EC\ADȤ\A3\ADn\BCg\A8\EC
     * \AA`\B7Npage c1\AA\BAc90\A6bDPK\B9L\B5{\A4\A4\A4d\B8U\A4\A3\AF\E0\B3Q\A8\E4\A5Lthread or process\A7\EF\BCg\A6\A8page c\AA\BAc90\AD\C8 */
	odm_write_4byte(dm, 0xc90, 0x0101f018);
...
)
{
	...
	/* regc20[15:13] = dB sel, \A7i\B6D Gain Loss function \A5h\B4M\A7\E4 dB_sel \A9ҳ]\A9w\AA\BAPA gain loss\A5ؼЩҹ\EF\C0\B3\AA\BA Tx AGC \AC\B0\A6\F3. */
	...
	/* read back Loopback Gain */
	/* \A5i\A5H\A6b d00[3:0] \A4\A4Ū\A6^, dB_sel \A4\A4\A9ҳ]\A9w\AA\BA gain loss \B7|\B8\A8\A6b\AD\FE\A4@\AD\D3 Tx AGC \B3]\A9w */
	/* Ū\A6^d00[3:0] = h'1 ' Tx AGC = h'13 */
	/* Ū\A6^d00[3:0] = h'2 ' Tx AGC = h'14 */
	/* Ū\A6^d00[3:0] = h'3 ' Tx AGC = h'15 */
	/* Ū\A6^d00[3:0] = h'4 ' Tx AGC = h'16 */
	/* Ū\A6^d00[3:0] = h'5 ' Tx AGC = h'17 */
	/* Ū\A6^d00[3:0] = h'6 ' Tx AGC = h'18 */
	/* Ū\A6^d00[3:0] = h'7 ' Tx AGC = h'19 */
	/* Ū\A6^d00[3:0] = h'8 ' Tx AGC = h'1a */
	/* Ū\A6^d00[3:0] = h'9 ' Tx AGC = h'1b */
	/* Ū\A6^d00[3:0] = h'a ' Tx AGC = h'1c */
	/*  */
...
)
{
	...
	/* RF setting, \AD\AB\B7s\B3]\A9wRF reg00, \C1|\A8ҥ\CEDPK Phase 2\B1o\A8쪺 d00[3:0] = 0x6 ' TX AGC= 0x18 ' RF reg00[4:0] = 0x18 */
...
)
{
	...
	/* reg82c[31] = 0 --> \A4\C1\A8\EC page C */
	odm_write_4byte(dm, 0x82c, 0x002083dd);
	/* RF setting, \A6\B9\B3BRF reg00, \BBP DPK Phase 3 \A4@\ADP */
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x00, RFREGOFFSETMASK, cali_info->dpk_tx_agc);
	...
	cali_info->dpk_thermal[RF_PATH_A] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Ū\A5X42[15:10] \ADȨæs\A8\EC\C5ܼ\C6TMeter */
	...
	odm_write_4byte(dm, 0xcb8, 0x00000000);
	/* dp_fail\B3o\AD\D3bit\A6bd00[6], \B7\ED d00[6] = 1, \AA\ED\A5\DCcalibration\A5\A2\B1\D1. */
	reg0xd00 = odm_read_4byte(dm, 0xd00);
	...
	/* \ADp\BA\E2tmpGainLoss \A5Ψ쪺function hex2dec() \ACO\B1N twos complement\AA\BA\A4Q\A4\BB\B6i\A6\EC\C2ন\A4Q\B6i\A6\EC, \A4Q\A4\BB\B6i\A6쪺\AE榡\AC\B0s11.9 */
	/* \C1|\A8\D21, d00[10:0] = h'3ff, \B8g\B9L hex2dec(h'3ff) = 1023, */
	/* \C1|\A8\D22, d00[10:0] = h'400, \B8g\B9L hex2dec(h'400) = -1024, */
	/* \C1|\A8\D23, d00[10:0] = h'0A9, \B8g\B9L hex2dec(h'0A9) = 169, */
	/* \C1|\A8\D24, d00[10:0] = h'54c, \B8g\B9L hex2dec(h'54c) = -692, */
	/* \C1|\A8\D24, d00[10:0] = h'7ff, \B8g\B9L hex2dec(h'7ff) = -1, */
	tmp_lb_gain = _compute_loop_back_gain_path_a(dm);
...
)
{
	...
	/* enable IQC matrix --> \A6]\AC\B0 BB \ABH\B8\B9\B7|\A5\FD\B8g\B9L predistortion module, \A4~\B8g\B9L IQC matrix \A8\EC DAC \A5\B4\A5X\A5h */
	/* \A9ҥH\ADn\A5\FD enable predistortion module {c90[7] = 1 (enable_predis) cc4[18] = 1 (\BDT\A9w\C5\FD IQK/DPK module \A6\B3clock), cc8[29] = 1 (\A4@\AD\D3IQK/DPK module \B8̪\BAmux, \BDT\BB{ data path \A8\ABIQK/DPK)} */
	...
	if (cali_info->is_dpk_fail) {
		...
		/* PWSF */
		/* \BCgPWSF table in 1st SRAM for PA = 11 use */
		odm_write_4byte(dm, 0xc20, 0x00000800);

		/* ******************************************************* */
		/* 0xce4[0]\ACOwrite enable\A1A0xce4[7:1]\ACOaddress\A1A0xce4[15:8]\A9M0xce4[23:16]\B9\EF\C0\B3\A8\ECTX index\A1A */
		/* \ADY\A6\EC\B8m\AC\B00(0xce4[7:1] = 0x0)\A6\B9\AE\C90xce4[15:8]\B9\EF\C0\B3\A8쪺TX RF index \ACO0x1f,\A1A */
		/* 0xce4[23:16]\B9\EF\C0\B3\A8쪺\ACO0x1e\A1A\ADY\A6\EC\B8m\AC\B01(0xce4[7:1] = 0x1)\A1A\A6\B9\AE\C90xce4 [15:8]\B9\EF\C0\B3\A8\EC0x1d\A1A */
		/* 0xce4[23:16]\B9\EF\C0\B30x1c\A1A\A8\E4\A5L\A8̦\B9\C3\FE\B1\C0\A1A\A8C\AD\D3data\C4\E6\A6쳣\ACO\ACۮt1dB\A1C\ADYgainloss\A7\E4\A8쪺RF TX index=0x18\A1A */
		/* \ABh\A6b0xce4 address\B9\EF\C0\B3\A8\EC0x18\AA\BA\A6a\A4\E8\ADn\B6\F10x40(\A4]\B4N\ACO0dB)\A1A\A8\E4\A5L\ABh\B7ӤU\AD\B1table\AA\BA\B6\B6\A7ǨC\AE\E61dB\A8̧ǱƦC */
		/* \B1N\A9Ҧ\B3\AA\BA0xce4c\AA\BAdata\C4\E6\A6쳣\B6\F1\A4J\AC۹\EF\C0\B3\AA\BA\ADȡC */
		/* ************************************************************* */
...
)
{
	...
	odm_set_bb_reg(dm, R_0xed4, 0xFFF000, 0x100);  /* \B1Ncd4[23:12] \A7令 h'100, \A8䥦\A6줸\BDЫO\AFd\AD\EC\ADȤ\A3\ADn\BCg\A8\EC
     * \AA`\B7Npage c1\AA\BAc90\A6bDPK\B9L\B5{\A4\A4\A4d\B8U\A4\A3\AF\E0\B3Q\A8\E4\A5Lthread or process\A7\EF\BCg\A6\A8page c\AA\BAc90\AD\C8 */
	odm_write_4byte(dm, 0xe90, 0x0101f018);
...
)
{
	...
	/* read back Loopback Gain */
	/* \A5i\A5H\A6b d40[3:0] \A4\A4Ū\A6^, dB_sel \A4\A4\A9ҳ]\A9w\AA\BA gain loss \B7|\B8\A8\A6b\AD\FE\A4@\AD\D3 Tx AGC \B3]\A9w */
	/* Ū\A6^d00[3:0] = h'1 ' Tx AGC = h'13 */
	/* Ū\A6^d00[3:0] = h'2 ' Tx AGC = h'14 */
	/* Ū\A6^d00[3:0] = h'3 ' Tx AGC = h'15 */
	/* Ū\A6^d00[3:0] = h'4 ' Tx AGC = h'16 */
...
)
{
	...
	/* RF setting, \AD\AB\B7s\B3]\A9wRF reg00, \C1|\A8ҥ\CEDPK Phase 2\B1o\A8쪺 d40[3:0] = 0x6 ' TX AGC= 0x18 ' RF reg00[4:0] = 0x18 */
...
)
{
	...
	/* T-meter RFReg42[17] = 1 to enable read T-meter, [15:10] ' T-meter value */
	odm_set_rf_reg(dm, RF_PATH_A, RF_0x42, BIT(17), 1);
	cali_info->dpk_thermal[RF_PATH_B] = odm_get_rf_reg(dm, RF_PATH_A, RF_0x42, 0xFC00);					/* Ū\A5X42[15:10] \ADȨæs\A8\EC\C5ܼ\C6TMeter */
	...
	/* read back dp_fail report */
	odm_write_4byte(dm, 0xeb8, 0x00000000);
	/* dp_fail\B3o\AD\D3bit\A6bd40[6], \B7\ED d40[6] = 1, \AA\ED\A5\DCcalibration\A5\A2\B1\D1. */
	reg0xd40 = odm_read_4byte(dm, 0xd40);
...
)
{
	...
	if (cali_info->is_dpk_fail) {
		...
		/* ******************************************************* */
		/* 0xee4[0]\ACOwrite enable\A1A0xee4[7:1]\ACOaddress\A1A0xee4[15:8]\A9M0xee4[23:16]\B9\EF\C0\B3\A8\ECTX index\A1A */
		/* \ADY\A6\EC\B8m\AC\B00(0xee4[7:1] = 0x0)\A6\B9\AE\C90xee4[15:8]\B9\EF\C0\B3\A8쪺TX RF index \ACO0x1f,\A1A */
		/* 0xee4[23:16]\B9\EF\C0\B3\A8쪺\ACO0x1e\A1A\ADY\A6\EC\B8m\AC\B01(0xee4[7:1] = 0x1)\A1A\A6\B9\AE\C90xee4 [15:8]\B9\EF\C0\B3\A8\EC0x1d\A1A */
		/* 0xee4[23:16]\B9\EF\C0\B30x1c\A1A\A8\E4\A5L\A8̦\B9\C3\FE\B1\C0\A1A\A8C\AD\D3data\C4\E6\A6쳣\ACO\ACۮt1dB\A1C\ADYgainloss\A7\E4\A8쪺RF TX index=0x18\A1A */
		/* \ABh\A6b0xee4 address\B9\EF\C0\B3\A8\EC0x18\AA\BA\A6a\A4\E8\ADn\B6\F10x40(\A4]\B4N\ACO0dB)\A1A\A8\E4\A5L\ABh\B7ӤU\AD\B1table\AA\BA\B6\B6\A7ǨC\AE\E61dB\A8̧ǱƦC */
		/* \B1N\A9Ҧ\B3\AA\BA0xee4c\AA\BAdata\C4\E6\A6쳣\B6\F1\A4J\AC۹\EF\C0\B3\AA\BA\ADȡC */
		/* ************************************************************* */
